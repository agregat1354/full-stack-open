const { dummy, totalLikes, favouriteBlog, mostBlogs, mostLikes } = require('../utils/list_helper.js')
...
describe('total likes', () => {
    ...
    test('when there is only one blog post, equals to the likes of that', () => {
        expect(totalLikes([blogs[1]])).toBe(5)
    })

    test('sum up all likes', () => {
        expect(totalLikes(blogs)).toBe(36)
    })

    test('if array of blogs is empty, return 0', () => {
...
describe('favourite blog', () => {
    ...
    test('when there are 2 blogs with highest amount of likes, return one of them', () => {
...
describe('most blogs', () => {
    ...
    test('when empty array is passed, return null', () => {
        expect(mostBlogs([])).toBe(null)
    })

    test('when array of blog objects is passed, return oject representing author with most blogs', () => {
